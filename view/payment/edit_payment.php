            ...
            <div class="panel panel-default"><!-- panel panel-default begin -->
                ...
                <div class="panel-body"><!-- panel-body begin -->
                    <?php foreach ($payments as $payment){ ?>
                        <form action="index.php?controller=payment&action=update" class="form-horizontal" method="post"><!-- form-horizontal begin -->
                            <input type="hidden" name="id" value="<?= $payment['method_id'] ?>">
                            <div class="form-group"><!-- form-group begin -->
                                ...
                                <div class="col-md-6"><!-- col-md-6 begin -->
                                    ...
                                    <input value="<?= $payment['method_name'] ?>" name="method_name" type="text" class="form-control">
